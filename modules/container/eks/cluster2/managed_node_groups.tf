locals {
  ...
  multi_single_az_node_group_templates = [for i, pair in setproduct(local.single_multi_az_node_group_templates, var.zones_to_span) : {
    ...
    subnet_ids               = [var.node_group_subnet_ids[i % length(var.zones_to_span)]]
