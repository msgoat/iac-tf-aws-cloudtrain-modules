locals {
  ...
  elasticsearch_release_name = "trace-db"
  elasticsearch_service_name = "${local.elasticsearch_release_name}-eck-elasticsearch-es-http"
  elasticsearch_service_port = 9200
  elasticsearch_credentials_k8s_secret_name = "${local.elasticsearch_release_name}-eck-elasticsearch-es-elastic-user"
  elasticsearch_certificates_k8s_secret_name = "${local.elasticsearch_release_name}-eck-elasticsearch-es-http-certs-public"
