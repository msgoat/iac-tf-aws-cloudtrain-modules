...
variable "domain_name" {
  description = "Name of a DNS domain the newly created Route53 hosted zone should manage."
  type        = string
}
...
variable "parent_domain_name" {
  description = "Optional name of a DNS domain/Route53 hosted zone the newly created hosted zone should be linked to; if missing, the name of the parent domain is derived from the given `domain_name`"
  type        = string
  default  = ""
}
